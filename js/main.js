...
/* harmony import */ var _components_portfolios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/portfolios */ "./src/js/components/portfolios.js");
/* harmony import */ var _components_portfolios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_portfolios__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_ya_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/ya_map */ "./src/js/components/ya_map.js");
/* harmony import */ var _components_ya_map__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_ya_map__WEBPACK_IMPORTED_MODULE_2__);
...
// import Accardion from './components/accardion.js';
// const accardion1 = new Accardion('.accardion-1', {
// });
// const accardion2 = new Accardion('.accardion-2', {
// });
// const accardion3 = new Accardion('.accardion-3', {
// });
// const accardion4 = new Accardion('.accardion-4', {
// });
// const accardion5 = new Accardion('.accardion-5', {
// });
...
aos__WEBPACK_IMPORTED_MODULE_2___default().refreshHard(); // Определение ширины экрана
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  testiSliderEl: (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.testimonials__slider'),
  testiPag: (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelector('.testimonials-pagination'),
  clientsSliderEl: (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelector('.clients__slider')
});
...
/* harmony import */ var _vendor_materialize_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/materialize.min */ "./src/js/vendor/materialize.min.js");
/* harmony import */ var _vendor_materialize_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_materialize_min__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_aos__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/aos */ "./src/js/vendor/aos.js");
/* harmony import */ var _vendor_aos__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_aos__WEBPACK_IMPORTED_MODULE_2__);
...
/***/ "./src/js/components/portfolios.js":
/*!*****************************************!*\
  !*** ./src/js/components/portfolios.js ***!
  \*****************************************/
/***/ (() => {
...
(function () {
  var portfoliosTubs = document.querySelector('.portfolios-tubs');
  var portfoliosTubsBtns = document.querySelectorAll('.portfolios-tubs__btn');
  var portfoliosTubsItems = document.querySelectorAll('.gallery__item');
  var loadMore = document.querySelector('.portfolios-more');

  var isLoad_MoreNeeded = function isLoad_MoreNeeded(selector) {
  ...
  portfoliosTubs.addEventListener('click', function (e) {
    var target = e.target;
    var portfoliosTubsItemsVisible = document.querySelectorAll('.gallery__item--visible');

    if (target.classList.contains('portfolios-tubs__btn')) {
      var path = target.dataset.path; // Выбор активных кнопок

      portfoliosTubsBtns.forEach(function (el) {
        el.classList.remove('portfolios-tubs__btn--active');
        target.classList.add('portfolios-tubs__btn--active');
      }); // Скрываем все items

      portfoliosTubsItems.forEach(function (el) {
        el.classList.add('visually-hidden'); // убираем у всех класс --visible

        el.classList.remove('gallery__item--visible');
        el.classList.remove('gallery__item--visible-more');
      }); // выбрали нужный data-path атрибут и убрали скрытие именно им

      document.querySelectorAll("[data-target=\"".concat(path, "\"]")).forEach(function (el) {
        el.closest('.gallery__item').classList.remove('visually-hidden');
        el.closest('.gallery__item').classList.add('gallery__item--visible');
      });
      isLoad_MoreNeeded(document.querySelectorAll("[data-target=\"".concat(path, "\"]")));

      if (path == 'all') {
        portfoliosTubsItems.forEach(function (el, i) {
          if (i <= 2) {
            el.classList.remove('visually-hidden');
            el.classList.add('gallery__item--visible');
          }
        });
        isLoad_MoreNeeded(document.querySelectorAll('.gallery__item'));
      }

      portfoliosTubsItemsVisible = document.querySelectorAll('.gallery__item--visible');
    } // isLoad_MoreNeeded(portfoliosTubsItemsVisible);

  });
  loadMore.addEventListener('click', function (e) {
    // const visibleItems = document.querySelectorAll('.gallery__item--visible');
    var path = document.querySelector('.portfolios-tubs__btn--active').dataset.path;

    if (path == 'all') {
      portfoliosTubsItems.forEach(function (el) {
        el.closest('.gallery__item').classList.remove('visually-hidden');
        el.closest('.gallery__item').classList.add('gallery__item--visible-more');
        loadMore.classList.add('visually-hidden');
      });
    } else {
      document.querySelectorAll("[data-target=\"".concat(path, "\"]")).forEach(function (el) {
...
//   let portfoliosTubsItemsVisible = document.querySelectorAll('.gallery__item--visible');
//   if (portfoliosTubsItemsVisible.length <= 6) {
//     loadMore.classList.add('visually-hidden');
//   } else {
//     loadMore.classList.remove('visually-hidden');
//   }
// } else {
//   let portfoliosTubsItemsVisible = document.querySelectorAll('.gallery__item--visible');
//   if (portfoliosTubsItemsVisible.length <= 3) {
//     loadMore.classList.add('visually-hidden');
//   } else {
//     loadMore.classList.remove('visually-hidden');
//   }
// }
// (function () {
//   const portfoliosTubs = document.querySelector('.portfolios-tubs');
//   const portfoliosTubsBtns = document.querySelectorAll('.portfolios-tubs__btn');
//   const portfoliosTubsItems = document.querySelectorAll('.gallery__item');
//   const loadMore = document.querySelector('.portfolios-more')
//   portfoliosTubs.addEventListener('click', (e) => {
//     const target = e.target;
//     if (target.classList.contains('portfolios-tubs__btn')) {
//       const path = target.dataset.path;
//       portfoliosTubsBtns.forEach(el => {
//         el.classList.remove('portfolios-tubs__btn--active');
//         target.classList.add('portfolios-tubs__btn--active');
//       })
//       portfoliosTubsItems.forEach(el => {
//         el.classList.remove('gallery__item--visible');
//       })
...
//         })
//       }
//       const portfoliosTubsItemsVisible = document.querySelectorAll('.gallery__item--visible');
//       if (portfoliosTubsItemsVisible.length <= 3) {
...
window.onscroll = function () {
  if (window.scrollY > 150) {
    scrollBtn.classList.add('scrollup_show');
  } else if (window.scrollY < 50) {
    scrollBtn.classList.remove('scrollup_show');
  }
};
...
var swiperTestimonials = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](_vars__WEBPACK_IMPORTED_MODULE_0__["default"].testiSliderEl, {
  slidesPerView: 1,
  loop: false,
  pagination: {
    el: _vars__WEBPACK_IMPORTED_MODULE_0__["default"].testiPag,
    type: 'bullets',
    clickable: true
  },
  autoHeight: true,
...
var swiperClients = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](_vars__WEBPACK_IMPORTED_MODULE_0__["default"].clientsSliderEl, {
  slidesPerView: 6,
  spaceBetween: 15,
  loop: true,
  speed: 2000,
...
console.log(swiperClients.params); // swiperClients.autoplay.start();
// console.log(swiperClients.autoplay.running);
// _vars.clientsSliderEl.addEventListener("mouseover", function (e) {
//   swiperClients.params.autoplay.disableOnInteraction = false;
//   swiperClients.params.autoplay.delay = 500;
//   swiperClients.autoplay.start();
// })

/***/ }),

/***/ "./src/js/components/ya_map.js":
/*!*************************************!*\
  !*** ./src/js/components/ya_map.js ***!
  \*************************************/
/***/ (() => {

var centerMark = [59.910148, 30.284606];
ymaps.ready(init);

function init() {
  var map = new ymaps.Map('mapEHAG', {
    center: centerMark,
    zoom: 16
  });
  var placemark = new ymaps.Placemark(centerMark, {}, {
...
(function () {
  ...
  var overlay = (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelector('[data-menu-overlay]');
  burger === null || burger === void 0 ? void 0 : burger.addEventListener('click', function (e) {
    ...
    overlay === null || overlay === void 0 ? void 0 : overlay.classList.toggle('visually-hidden');
    ...
    if (burger !== null && burger !== void 0 && burger.classList.contains('burger--active')) {
      elems.style.transform = "translateX(0%)"; // burger?.classList.remove('burger--active');
      // disableScroll();
    } else {
      elems.style.transform = "translateX(-105%)";
  ...
  overlay === null || overlay === void 0 ? void 0 : overlay.addEventListener('click', function () {
    burger === null || burger === void 0 ? void 0 : burger.classList.toggle('burger--active');
    menu === null || menu === void 0 ? void 0 : menu.classList.toggle('menu--active');
    overlay === null || overlay === void 0 ? void 0 : overlay.classList.add('visually-hidden');
    ...
    if (burger !== null && burger !== void 0 && burger.classList.contains('burger--active')) {
      elems.style.transform = "translateX(0%)"; // disableScroll();
    } else {
      elems.style.transform = "translateX(-105%)";
  ...
  }); // if (burgerHeader?.classList.contains('burger--active')) {
  //   console.log(instance)
  //   console.log(burgerHeader?.classList.contains('burger--active'));
  //   console.log(elems);
  //   elems.style.transform = "translateX(-105%)";
  // }
...
/***/ "./src/js/vendor/materialize.min.js":
/*!******************************************!*\
  !*** ./src/js/vendor/materialize.min.js ***!
  \******************************************/
/***/ (function(module, exports, __webpack_require__) {
